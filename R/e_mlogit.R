...
cat(" n <- 1000 ", '\n')
cat(" data <- data.frame( ", '\n')
cat(" debt_type = sample(c('NoDebt', 'debt1', 'debt2', 'debt3'), n, replace = TRUE), ", '\n')
cat(" gender = sample(c('male', 'female'), n, replace = TRUE), ", '\n')
...
cat(" data$debt_type <- relevel(data$debt_type, ref = 'NoDebt') ", '\n')
cat(" ", '\n')
